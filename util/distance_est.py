...
def calculate_distance(box_coord, frame_2, name):
    ...
    for i in range(n_objects):
        ...
        if y2 > height_threshold:
            ...
            DISTANCE_H, frame_2 = distance_from_horizon(virtual_horizon, x1, y1, y2, cam_height, name[i], frame_2)
            DIST_H_per_FRAME.append(DISTANCE_H)

    return DIST_H_per_FRAME, DIST_2_per_FRAME, frame_2, box_coord_2, name_2
...
def estimate_virtual_horizon(box_coord, frame_x, frame_y, frame_2, height_threshold):
        ...
        if obj_count == 0:
            return frame_2, None, cam_height

        avg_w_y     =  sum_w_y/obj_count
        avg_w_b     =  sum_w_b/obj_count
